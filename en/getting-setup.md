1. These Sushi Cards will help you learn to build webpages using PHP, a very popular programming language that's used to build websites like _Facebook_ and _Wikipedia_. You can combine it with _HTML_ \(and check out the HTML Sushi Cards if you don't know how to code HTML yet!\).
...
4. Choose "Create a new workspace" and fill it in as follows:
   ...
   * Choose the **PHP, Apache ...** template, with the icon like this
     ![](/assets/php logo.png)
5. When everything's done, it should look a little like this ![](/assets/c9-setup.png)
